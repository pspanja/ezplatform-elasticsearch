...
namespace Cabbage\Core\Document\BulkSerializer\Field;
...
final class ValueMapper
{
     ...
     *
     * @var \Cabbage\Core\Document\BulkSerializer\Field\ValueMapper\Visitor[]
     */
    private $visitors = [];

    /**
     * @param \Cabbage\Core\Document\BulkSerializer\Field\ValueMapper\Visitor[] $visitors
     */
     ...
     *
     * @param \Cabbage\Core\Document\BulkSerializer\Field\ValueMapper\Visitor $visitor
     */
