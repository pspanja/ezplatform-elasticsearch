...
namespace Cabbage\Tests\Integration\Core\HttpClient;
...
class ClientTest extends TestCase
{
    ...
    public function testGetRequestFound(): void
    {
        ...
        $message = new Message();
        $response = $client->get($message, "http://{$host}:{$port}/something.txt");
    ...
    public function testGetRequestNotFound(): void
    {
        ...
        $message = new Message();
        $response = $client->get($message, "http://{$host}:{$port}/not_found.mpg");
